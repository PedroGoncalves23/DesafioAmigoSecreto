            ...
            <form action="/cadastro/save" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" id="nome" name="nome" placeholder="Digite seu nome" required=""
                        oninvalid="setCustomValidity('Campo nome obrigatório')" oninput="setCustomValidity('')"
                        value="<?= $model->nome ?>" class="form-control">
                    <a>
                        <? $error ?>
                    </a>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="email" id="email" name="email" placeholder="Digite seu email" required=""
                        oninvalid="setCustomValidity('Digite um email válido!')" oninput="setCustomValidity('')"
